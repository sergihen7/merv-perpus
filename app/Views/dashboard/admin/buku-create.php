  ...
  <div class="col">
    <div class="card card-body rounded-0">
      ...
      <div class="mb-3">
        ...
        <input type="text" class="form-control" id="title" name="isbn">
      </div>
      ...
      <div class="row">
        <div class="col-12 col-md-6">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" name="tahun">
        ...
        <div class="col-12 col-md-6">
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" name="stock">
          </div>
        </div>
      </div>
      ...
      <div class="mb-3">
        ...
        <select name="rak" id="" placeholder="Pilih Anggota">
          ...
          <?php foreach ($rak as $k) : ?>
            <option value="<?= $k['id']; ?>"><?= $k['rak']; ?></option>
          <?php endforeach; ?>
        </select>
      </div>
    </div>
